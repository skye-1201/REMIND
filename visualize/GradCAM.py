...
def show_cam(index, imgpath, grayscale_cam, modality, cfg, n_iter):
    ...
    if cfg.DATASETS.NAMES == 'RGBNT201':
        img_path = f'/data/datasets/RGBNT201/test/{modality}/{img_path}'
    elif cfg.DATASETS.NAMES == 'RGBNT100':
        img_path = f'/data/datasets/RGBNT100/rgbir/query/{img_path}'
    ...
    output_dir = f'/data/xuzhendong/CAM/gradcam_vis/{cfg.DATASETS.NAMES}/{modality}'
...
if __name__ == "__main__":
    ...
    sr_memory = memory_data['sr']
    sn_memory = memory_data['sn']
    st_memory = memory_data['st']
    # 加载模型
